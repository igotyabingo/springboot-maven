package me.woosuyeon.product.management.application;

import me.woosuyeon.product.management.domain.Product;
import me.woosuyeon.product.management.infrastructure.DatabaseProductRepository;
import me.woosuyeon.product.management.presentation.ProductDto;
...
public class SimpleProductService {
    ...
    @Autowired
    SimpleProductService(DatabaseProductRepository databseProductRepository, ModelMapper modelMapper, ValidationService validationService) {
        this.databaseProductRepository = databseProductRepository;
